...
diabetes_model = pickle.load(open(
    'C:/Users/vayun/Documents/VSCODE_projects/disease_pred/saved models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open(
    'C:/Users/vayun/Documents/VSCODE_projects/disease_pred/saved models/heart_disease_model.sav', 'rb'))

parkinsons_model = pickle.load(open(
    'C:/Users/vayun/Documents/VSCODE_projects/disease_pred/saved models/parkinsons_model.sav', 'rb'))
...
if (selected == 'Heart Disease Prediction'):
    ...
    with col2:
        chol = float(st.text_input('Serum Cholestoral in mg/dl'))

    with col3:
        fbs = float(st.text_input('Fasting Blood Sugar > 120 mg/dl'))
